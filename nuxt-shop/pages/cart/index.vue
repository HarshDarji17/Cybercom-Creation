      ...
      <div class="col-md-3 mt-9">
        <v-card elevation="2">
          ...
          <v-card-text class="row mx-auto">
            <div>
              <p class="subtitle-1">Price ({{ cartQuantities }} items)</p>
          ...
          <v-card-title class="row mx-auto">
            ...
            <span class="ml-auto"
              >&#x20B9;
              {{ Math.round((cartTotal - cartTotal / 10) * 100) / 100 }}</span
            >
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
            <span class="subtitle-1" id="grn"
              >You will save &#x20B9; {{ Math.round(cartTotal * 10) / 100 }} on
              this order</span
            >
          </v-card-text>
        </v-card>
    ...
    <div v-else id="noProduct">
      <div class="row">
        <div class="col-sm-6">
          <div>
            <img
              :src="require('@/assets/svg/emptycart.png')"
              alt=""
              class="img-fluid"
              width="91%"
            />
          ...
          <div class="col-sm-6">
            ...
            <n-link id="addProduct" to="/products">
              <v-btn class="mt-10" color="primary" dark> Add Product </v-btn>
            </n-link>
          </div>
        </div>
      </div>
