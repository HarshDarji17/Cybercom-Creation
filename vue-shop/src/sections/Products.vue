          ...
          <div class="row">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img  :src="require('@/assets/products/product1.jpg')" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img :src="require('@/assets/products/product2.jpg')" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Furniture</h5>
                            <p class="card-text">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img :src="require('@/assets/products/product5.jpg')" class="card-img-top" alt="...">
                        <div class="card-body">
